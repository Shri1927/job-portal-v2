        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className='flex items-center gap-2 mb-4'>
              ...
              <h2 className="text-2xl font-bold text-gradient-secondary">Job<span className='text-gradient-primary'>Portal</span></h2>
            </div>
            <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
              Connecting talented professionals with their dream careers. 
              Find the perfect job or hire the best talent for your company.
            </p>
            <div className="flex space-x-4">
              <a href="https://facebook.com" className="w-10 h-10 bg-gradient-primary rounded-lg flex items-center justify-center hover:opacity-80 transition-all duration-200 shadow-lg" aria-label="Facebook">
              ...
              <a href="https://twitter.com" className="w-10 h-10 bg-gradient-secondary rounded-lg flex items-center justify-center hover:opacity-80 transition-all duration-200 shadow-lg" aria-label="Twitter">
              ...
              <a href="https://linkedin.com" className="w-10 h-10 bg-gradient-success rounded-lg flex items-center justify-center hover:opacity-80 transition-all duration-200 shadow-lg" aria-label="LinkedIn">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/jobs" className="text-gray-300 hover:text-white transition-colors duration-200">Browse Jobs</a></li>
              <li><a href="/companies" className="text-gray-300 hover:text-white transition-colors duration-200">Companies</a></li>
